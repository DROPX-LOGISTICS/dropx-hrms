...
export default async function PeoplePage({ searchParams }: { searchParams?: { add?: string; error?: string; notice?: string; search?: string; status?: string; location?: string; page?: string } }) {
  ...
  const [{ rows: employees, total, page, pageSize }, locations, designations] = await Promise.all([
  ...
  return <>
    ...
    <section className="panel">
      ...
      <Pagination page={page} pageSize={pageSize} total={total} basePath="/people" searchParams={searchParams} />
    </section>
  </>;
}
